	...
	float screenDepth, float screenNear)
{
	...
	m_device->CreateBlendState(&blendDesc, &d2dTransparency);
...
void D3DClass::PrepareModel() {
	
	//Rotate = XMMatrixIdentity();	//(XM_PIDIV2);
	...
	smilesWorld = Translation */* Rotate * */Scale;
}

void D3DClass::SetStateCullNone() {
...
{
	worldMatrix = smilesWorld;
	return;
}

void D3DClass::GetProjectionMatrix(XMMATRIX& projectionMatrix)
{
	projectionMatrix = camProjection;
	return;
}