...
void PositionClass::MoveForward(bool keydown)
{
	...
	// Update the position.
	m_positionX += sinf(radians) * m_forwardSpeed * 0.03f;
	m_positionZ += cosf(radians) * m_forwardSpeed * 0.03f;
...
void PositionClass::MoveBackward(bool keydown)
{
	...
	// Update the position.
	m_positionX -= sinf(radians) * m_backwardSpeed * 0.03f;
	m_positionZ -= cosf(radians) * m_backwardSpeed * 0.03f;
